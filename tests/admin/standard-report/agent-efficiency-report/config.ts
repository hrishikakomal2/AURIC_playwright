...
//
// CAVEAT: because this folder's vars are unprefixed (AGENT_NAME, not e.g. AGEFF_AGENT_NAME),
...
export interface AgentEfficiencyConfig {
...
export function loadAgentEfficiencyConfig(): AgentEfficiencyConfig {
